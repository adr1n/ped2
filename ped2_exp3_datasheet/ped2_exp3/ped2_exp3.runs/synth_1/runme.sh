...
HD_PWD='C:/Users/andre/Downloads/ped2_exp3_datasheet/ped2_exp3/ped2_exp3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pblaze.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pblaze.tcl
