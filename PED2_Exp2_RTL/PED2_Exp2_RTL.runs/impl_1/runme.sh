...
HD_PWD='C:/Unb/Projetos Vivado/Ped2/PED2_Exp2_RTL/PED2_Exp2_RTL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_modu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_modu.tcl -notrace
