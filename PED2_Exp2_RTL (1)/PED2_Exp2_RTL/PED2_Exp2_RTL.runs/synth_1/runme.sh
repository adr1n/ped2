...
HD_PWD='C:/Unb/Projetos Vivado/Ped2/PED2_Exp2_RTL/PED2_Exp2_RTL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_modu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_modu.tcl
